...
class ProductCategory(models.Model):
    """Extended Product Categories with SaaS synchronization.

    This model extends the standard product category model to include SaaS
    ...
    for product category records.
    """

    _name = "product.category"
    _inherit = ["product.category", "saas.mixin"]
