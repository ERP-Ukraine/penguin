...
class StockPicking(models.Model):
    """Extended Stock Pickings with SaaS synchronization.

    This model extends the standard stock picking model to include SaaS
    ...
    for stock picking records.
    """

    _name = "stock.picking"
    _inherit = ["stock.picking", "saas.mixin"]
