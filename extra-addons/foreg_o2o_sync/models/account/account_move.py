...
class AccountMove(models.Model):
    """Extended Journal Entries with SaaS synchronization.

    This model extends the standard journal entry model to include SaaS
    ...
    for journal entry records.
    """

    _name = "account.move"
    _inherit = ["account.move", "saas.mixin"]
