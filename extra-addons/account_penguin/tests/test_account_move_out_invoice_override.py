...
def test_out_invoice_line_onchange_product_2_with_fiscal_pos_1(self):
    ...
    The price_unit should be 110.0 after applying the fiscal position.
    """
        ...
        [
            {
                'product_id': product.id,
                'price_unit': 220.0,
                'price_subtotal': 183.333,
                'price_total': 220.0,
                'tax_ids': tax_price_include_2.ids,
                'tax_line_id': False,
                'currency_id': self.other_currency.id,
                'amount_currency': -183.333,
                'debit': 0.0,
                'credit': 91.67,
            },
            {
...
TestAccountMoveOutInvoiceOnchanges.test_out_invoice_line_onchange_product_2_with_fiscal_pos_1 = test_out_invoice_line_onchange_product_2_with_fiscal_pos_1
TestAccountMoveOutInvoiceOnchanges.test_out_invoice_line_onchange_product_2_with_fiscal_pos_2 = test_out_invoice_line_onchange_product_2_with_fiscal_pos_2
